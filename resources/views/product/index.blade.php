        ...
        $(document).ready( function(){
            product_table = $('#product_table').DataTable({
                ...
                columns: [
                        ...
                        { data: 'pieces', name: 'products.pieces'}
            ...
            if ($(e.target).attr('href') == '#product_stock_report') {
                if (!data_table_initailized) {
                    ...
                    var stock_report_cols = [
                        ...
                        { data: 'pieces', name: 'pieces', searchable: false },
                        ...
                        { data: 'total_pieces_sold', name: 'total_pieces_sold', searchable: false },
                    ...
                    stock_report_table = $('#stock_report_table').DataTable({
                        ...
                        "footerCallback": function ( row, data, start, end, display ) {
                            ...
                            var footer_total_pieces = 0;
                            var footer_total_sold = 0;
                            var footer_total_pieces_sold = 0;
                            ...
                            var footer_stock_value_by_sale_price = sum_table_col($('#stock_report_table'), 'stock_value_by_sale_price');
                            ...
                            for (var r in data){
                                ...
                                footer_total_pieces += $(data[r].pieces).data('orig-value') ? 
                                parseFloat($(data[r].pieces).data('orig-value')) : 0;

                                footer_total_sold += $(data[r].total_sold).data('orig-value') ? 
                                parseFloat($(data[r].total_sold).data('orig-value')) : 0;

                                footer_total_pieces_sold += $(data[r].total_pieces_sold).data('orig-value') ? 
                                parseFloat($(data[r].total_pieces_sold).data('orig-value')) : 0;
                            ...
                            $('.footer_total_pieces').html(__currency_trans_from_en(footer_total_pieces, false));
                            ...
                            $('.footer_total_pieces_sold').html(__currency_trans_from_en(footer_total_pieces_sold, false));
