...
{!! Form::open(['url' => action('ProductController@store'), 'method' => 'post',
    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-sm-4">
          ...
          <div class="col-sm-4">
            <div class="form-group">
              {!! Form::label('pieces',  __('lang_v1.pieces') . ':') !!}
              {!! Form::text('pieces', !empty($duplicate_product->pieces) ? $duplicate_product->pieces : null, ['class' => 'form-control', 'placeholder' => __('lang_v1.pieces')]); !!}
            </div>
          </div>
        @php
