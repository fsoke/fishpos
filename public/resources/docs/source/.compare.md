...
[Get Postman Collection](https://www.ikomali.com/public/docs/collection.json)
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "http://www.ikomali.com/public/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"laudantium","ip_address":"ea","latitude":"error","longitude":"quas"}'
...
```bash
curl -X POST \
    "http://www.ikomali.com/public/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"repudiandae","latitude":"ullam","longitude":"facere"}'
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/holidays?location_id=et&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=voluptatem&follow_up_type=officiis&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/crm/follow-ups"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"quasi","schedule_type":"qui","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","followup_additional_info":"['call duration' => '1 hour']","allow_notification":true}'
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=rem&biz_name=aliquam&mobile_num=6&contact_id=recusandae&order_by=adipisci&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "http://www.ikomali.com/public/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"recusandae","mobile_name":"expedita","call_type":"call","start_time":"laborum","end_time":"fugit","duration":"nobis"}]}'
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=voluptas&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":14,"initial_amount":380636673.95586306,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":28816326.160035,"total_card_slips":6,"total_cheques":11,"closing_note":"blanditiis","transaction_ids":"1,2,3"}'
...
let body = {
    "location_id": 14,
    "initial_amount": 380636673.95586306,
    "created_at": "2020-5-7 15:20:22",
    "closed_at": "2020-5-7 15:20:22",
    "status": "close",
    "closing_amount": 28816326.160035,
    "total_card_slips": 6,
    "total_cheques": 11,
    "closing_note": "blanditiis",
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/contactapi?type=molestias&name=ipsum&biz_name=ut&mobile_num=16&contact_id=corporis&order_by=aperiam&direction=est&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"consequatur","prefix":"magni","first_name":"dolorem","middle_name":"eaque","last_name":"fugiat","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"molestiae","address_line_2":"error","city":"exercitationem","state":"odio","country":"magnam","zip_code":"praesentium","customer_group_id":"est","contact_id":"saepe","dob":"2000-06-13","custom_field1":"autem","custom_field2":"maxime","custom_field3":"dolore","custom_field4":"illum","email":"libero","shipping_address":"molestias","position":"esse","opening_balance":0,"source_id":18,"life_stage_id":5,"assigned_to":[]}'
...
let body = {
    ...
    "address_line_1": "molestiae",
    "address_line_2": "error",
    "city": "exercitationem",
    "state": "odio",
    "country": "magnam",
    "zip_code": "praesentium",
    "customer_group_id": "est",
    "contact_id": "saepe",
    "dob": "2000-06-13",
    "custom_field1": "autem",
    "custom_field2": "maxime",
    "custom_field3": "dolore",
    "custom_field4": "illum",
    "email": "libero",
    "shipping_address": "molestias",
    "position": "esse",
    "opening_balance": 0,
    "source_id": 18,
    "life_stage_id": 5,
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"eaque","prefix":"quasi","first_name":"cumque","middle_name":"excepturi","last_name":"similique","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"distinctio","address_line_2":"quis","city":"eveniet","state":"omnis","country":"ut","zip_code":"explicabo","customer_group_id":"nesciunt","contact_id":"quia","dob":"2000-06-13","custom_field1":"sint","custom_field2":"dolor","custom_field3":"quis","custom_field4":"culpa","email":"ad","shipping_address":"dolorem","position":"quam","opening_balance":10.3,"source_id":20,"life_stage_id":16,"assigned_to":[]}'
...
```bash
curl -X POST \
    "http://www.ikomali.com/public/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":5,"card_number":"voluptates","card_holder_name":"ut","card_transaction_number":"sint","card_type":"et","card_month":"accusamus","card_year":"recusandae","card_security":"nemo","transaction_no_1":"voluptatem","transaction_no_2":"ab","transaction_no_3":"et","cheque_number":"rerum","bank_account_number":"est","note":"possimus"}'
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/expense?location_id=doloremque&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=occaecati&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/expense"
);

let params = {
    "location_id": "doloremque",
    "payment_status": "paid",
    "start_date": "2018-06-25",
    "end_date": "2018-06-25",
    "expense_for": "occaecati",
    "per_page": "15",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":19,"final_total":247619.011,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":9,"expense_for":12,"contact_id":19,"additional_notes":"et","is_refund":0,"is_recurring":0,"recur_interval":7,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"nostrum","recur_repetitions":7,"payment":[{"amount":453.13,"method":"cash","account_id":13,"card_number":"minima","card_holder_name":"excepturi","card_transaction_number":"corrupti","card_type":"sunt","card_month":"laboriosam","card_year":"id","card_security":"velit","transaction_no_1":"ipsam","transaction_no_2":"quo","transaction_no_3":"rerum","note":"fugiat","cheque_number":"dolore"}]}'
    ...
    "payment": [
        {
            ...
            "card_transaction_number": "corrupti",
            "card_type": "sunt",
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "http://www.ikomali.com/public/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":51.7,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":5,"expense_for":5,"contact_id":2,"additional_notes":"aliquid","is_recurring":0,"recur_interval":8,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"veritatis","recur_repetitions":19,"payment":[]}'
...
let body = {
    ...
    "expense_for": 5,
    "contact_id": 2,
    "additional_notes": "aliquid",
    "is_recurring": 0,
    "recur_interval": 8,
    "recur_interval_type": "months",
    "subscription_repeat_on": 15,
    "subscription_no": "veritatis",
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/expense-refund?location_id=quia&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=voluptas&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/product?brand_id=suscipit&category_id=sit&sub_category_id=totam&location_id=iure&selling_price_group=expedita&name=repellat&sku=sunt&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/product"
);

let params = {
    "brand_id": "suscipit",
    "category_id": "sit",
    "sub_category_id": "totam",
    "location_id": "iure",
    "selling_price_group": "expedita",
    "name": "repellat",
    "sku": "sunt",
    "per_page": "10",
};
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/product/1?selling_price_group=aliquid" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/product/1"
);

let params = {
    "selling_price_group": "aliquid",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/variation/?brand_id=doloremque&category_id=autem&sub_category_id=assumenda&not_for_selling=consequatur&name=dignissimos&sku=blanditiis&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/variation/"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/sell?location_id=maiores&contact_id=dolorum&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&user_id=harum&service_staff_id=reprehenderit&shipping_status=ordered&only_subscriptions=voluptas&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/sell"
);
...
let params = {
    ...
    "end_date": "2018-06-25",
    "user_id": "harum",
    "service_staff_id": "reprehenderit",
    "shipping_status": "ordered",
    "only_subscriptions": "voluptas",
    "order_by_date": "desc",
    "per_page": "10",
};
Object.keys(params)
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":14,"contact_id":4,"transaction_date":"2020-07-22 15:48:29","invoice_no":"quia","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":9,"discount_amount":10,"discount_type":"fixed","sale_note":"qui","staff_note":"maiores","commission_agent":16,"shipping_details":"Express Delivery","shipping_address":"cum","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":13,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":20,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"dolores","recur_repetitions":5,"rp_redeemed":3,"rp_redeemed_amount":13.5,"types_of_service_id":2,"service_custom_field_1":"occaecati","service_custom_field_2":"id","service_custom_field_3":"inventore","service_custom_field_4":"et","service_custom_field_5":"sed","service_custom_field_6":"et","round_off_amount":20922.073309,"table_id":20,"service_staff_id":11,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":20,"note":"ipsum"}],"payments":[{"amount":453.13,"method":"cash","account_id":3,"card_number":"sunt","card_holder_name":"iusto","card_transaction_number":"deserunt","card_type":"hic","card_month":"illo","card_year":"ut","card_security":"molestias","transaction_no_1":"aperiam","transaction_no_2":"quia","transaction_no_3":"occaecati","bank_account_number":"dolor","note":"illum","cheque_number":"provident"}]}]}'
    ...
    "sells": [
        {
            ...
            "recur_interval_type": "months",
            "subscription_repeat_on": 15,
            "subscription_no": "dolores",
            "recur_repetitions": 5,
            "rp_redeemed": 3,
            "rp_redeemed_amount": 13.5,
            "types_of_service_id": 2,
            "service_custom_field_1": "occaecati",
            "service_custom_field_2": "id",
            "service_custom_field_3": "inventore",
            "service_custom_field_4": "et",
            "service_custom_field_5": "sed",
            "service_custom_field_6": "et",
            "round_off_amount": 20922.073309,
            "table_id": 20,
            "service_staff_id": 11,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "account_id": 3,
                    "card_number": "sunt",
                    "card_holder_name": "iusto",
                    "card_transaction_number": "deserunt",
                    "card_type": "hic",
                    "card_month": "illo",
                    "card_year": "ut",
                    "card_security": "molestias",
                    "transaction_no_1": "aperiam",
                    "transaction_no_2": "quia",
                    "transaction_no_3": "occaecati",
                    "bank_account_number": "dolor",
                    "note": "illum",
                    "cheque_number": "provident"
                }
            ]
        }
    ]
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/sell/55" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/sell/55"
);
...
```bash
curl -X PUT \
    "http://www.ikomali.com/public/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":11,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":20,"discount_amount":10,"discount_type":"fixed","sale_note":"quia","staff_note":"vel","sells":[{"is_suspend":false}],"commission_agent":1,"shipping_details":"Express Delivery","shipping_address":"suscipit","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":13,"pay_term_number":13,"pay_term_type":"months","is_recurring":0,"recur_interval":19,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"nostrum","recur_repetitions":11,"rp_redeemed":11,"rp_redeemed_amount":13.5,"types_of_service_id":5,"service_custom_field_1":"magni","service_custom_field_2":"quia","service_custom_field_3":"aut","service_custom_field_4":"quasi","service_custom_field_5":"aliquid","service_custom_field_6":"nobis","round_off_amount":39400466.6905702,"table_id":7,"service_staff_id":19,"change_return":0,"change_return_id":10,"products":[{"sell_line_id":8,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":20,"discount_amount":0,"discount_type":"percentage","sub_unit_id":11,"note":"expedita"}],"payments":[{"payment_id":2,"amount":453.13,"method":"cash","account_id":19,"card_number":"vel","card_holder_name":"dolorem","card_transaction_number":"veniam","card_type":"voluptates","card_month":"ducimus","card_year":"et","card_security":"veritatis","transaction_no_1":"provident","transaction_no_2":"earum","transaction_no_3":"dolor","note":"dignissimos","cheque_number":"et","bank_account_number":"iusto"}]}'
...
let body = {
    ...
    "service_custom_field_1": "magni",
    "service_custom_field_2": "quia",
    "service_custom_field_3": "aut",
    "service_custom_field_4": "quasi",
    "service_custom_field_5": "aliquid",
    "service_custom_field_6": "nobis",
    "round_off_amount": 39400466.6905702,
    "table_id": 7,
    "service_staff_id": 19,
    "change_return": 0,
    "change_return_id": 10,
    ...
    "payments": [
        {
            ...
            "account_id": 19,
            "card_number": "vel",
            "card_holder_name": "dolorem",
            "card_transaction_number": "veniam",
            "card_type": "voluptates",
            "card_month": "ducimus",
            "card_year": "et",
            "card_security": "veritatis",
            "transaction_no_1": "provident",
            "transaction_no_2": "earum",
            "transaction_no_3": "dolor",
            "note": "dignissimos",
            "cheque_number": "et",
            "bank_account_number": "iusto"
        }
    ]
}
...
```bash
curl -X DELETE \
    "http://www.ikomali.com/public/connector/api/sell/dolores" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "http://www.ikomali.com/public/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":6,"transaction_date":"2020-5-7 15:20:22","invoice_no":"dolorem","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":1,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "http://www.ikomali.com/public/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":11,"shipping_status":"ordered","delivered_to":"et"}'
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/table?location_id=porro" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/table"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/taxonomy?type=numquam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/user/loggedin"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/user?service_staff=debitis" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/user"
);

let params = {
    "service_staff": "debitis",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/user/1"
);
...
```bash
curl -X POST \
    "http://www.ikomali.com/public/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"officiis","new_password":"aut"}'
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/profit-loss-report?location_id=nemo&start_date=2018-06-25&end_date=2018-06-25&user_id=eaque" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "http://www.ikomali.com/public/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.ikomali.com/public/connector/api/notifications"
);
