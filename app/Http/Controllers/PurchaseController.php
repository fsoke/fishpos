    ...
    public function updateStatus(Request $request)
    {
        ...
        try {
            ...
            foreach ($transaction->purchase_lines as $purchase_line) {
                $this->productUtil->updateProductStock($before_status, $transaction, $purchase_line->product_id, $purchase_line->variation_id, $purchase_line->quantity,$purchase_line->quantity, $currency_details,$purchase_line->pieces);
            }
